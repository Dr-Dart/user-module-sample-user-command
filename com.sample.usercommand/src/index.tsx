...
*/
import { ModuleContext, BaseModule, ModuleScreen, ModuleScreenProps, System, logger, ModuleService } from 'dart-api';
...
class Module extends BaseModule {
    ...
    getModuleScreen(componentId: string) {
        logger.debug(`getModuleScreen: ${this.packageInfo.packageName}, ${componentId}`);
