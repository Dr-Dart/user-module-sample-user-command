...
*/
import { ModuleContext, Context, IModuleChannel, ModuleScreenProps, ModuleScreen, logger, SixNumArray } from 'dart-api';
//UI Setting
import { ThemeProvider } from '@mui/material/styles';
import styles from '../assets/styles/styles.scss';
import React, { createRef } from 'react';
import { Box, Divider, Grid, Switch, TextField, Select } from '@mui/material';
...
export default class UserCommandScreen2 extends ModuleScreen {
    ...
    private mathLibrary = this.moduleContext.getSystemLibrary(Context.MATH_LIBRARY) as IMathLibrary;
    ...
    convertPoseZyxToZyz = (zyxPose: SixNumArray) => {
        let zyz = this.mathLibrary.convertEuler(
            {
                pose: zyxPose,
                type: EulerType.ZYX,
            },
    ...
    onBind(message: Message, channel: IModuleChannel): boolean {
        ...
        channel.receive('changed_variables', (data) => {
            logger.debug('changed_variables request with data: ', data);
            if (data) {
                this.setState({ globalSystemVariable: data });
            }
        });
            ...
            <ThemeProvider theme={this.systemTheme}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            2. Select a Global/System Variable to store the converted zyz pose.
                        </Grid>
                        <Grid
                            item={true}
                            sx={{
